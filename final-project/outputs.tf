...
output "grafana_admin_password" {
  description = "Grafana admin password (from chart values)"
  value       = "admin123"
}

output "grafana_service_name" {
  description = "Service name for Grafana in 'monitoring' namespace"
  value       = "grafana"
}

output "prometheus_service_name" {
  description = "Service name for Prometheus in 'monitoring' namespace"
